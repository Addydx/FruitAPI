...
const RANGO_INICIO = 80; // índice de array (0-based) => fruta #81
const RANGO_FIN = 100; // exclusivo => fruta #100 incluida
const ID_MIN_ESPERADO = 81;
const ID_MAX_ESPERADO = 100;
